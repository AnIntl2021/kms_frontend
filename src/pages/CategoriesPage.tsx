        ...
        <div className="stock-table-card">
          <div className="table-wrapper">
            <table>
              ...
              <tbody>
                {loading ? (
                  <tr><td colSpan={4} className="text-center py-5">Loading categories...</td></tr>
                  ...
                  <React.Fragment key={parent.category_id}>
                    <tr className="parent-row">
                      ...
                      <td><span className="status-badge healthy">Primary</span></td>
                    ...
                    {getSubcategories(parent.category_id).map(sub => (
                      <tr key={sub.category_id} className="sub-row">
                        ...
                        <td><span className="status-badge" style={{background: '#f1f5f9', color: '#64748b'}}>Sub-Category</span></td>
          ...
          <div className="modal-content" style={{maxWidth: '500px'}}>
            ...
            <form onSubmit={handleSubmit} className="modal-body">
              <div className="form-group">
                <label>Parent Category (Optional - For Sub-Categories)</label>
                <select 
                ...
                >
                  ...
                  {parentCategories.filter(p => p.category_id !== editingCategory?.category_id).map(p => (
                    <option key={p.category_id} value={p.category_id}>{p.name_en}</option>
                  ))}
                </select>
              </div>
...
import React from 'react'; // Fix missing React for Fragment
