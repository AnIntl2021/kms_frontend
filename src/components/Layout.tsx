...
const Layout: React.FC<LayoutProps> = ({ children, title }) => {
  ...
  const allNavItems = [
    ...
    { name: t('analytics_forecasts'), path: '/analytics', icon: <BarChart2 size={20} />, section: 'Operations', permission: 'analytics' },
    { name: t('reports_bi'), path: '/reports', icon: <FileText size={20} />, section: 'Operations', permission: 'reports' },
    { name: t('food_cost'), path: '/food-cost', icon: <Calculator size={20} />, section: 'Operations', permission: 'inventory' },
    ...
    { name: 'Branch Management', path: '/branch-management', icon: <Store size={20} />, section: 'Admin', permission: 'settings' },
    { name: 'Brand Management', path: '/brand-management', icon: <FolderTree size={20} />, section: 'Admin', permission: 'settings' },
    { name: 'POS Counters', path: '/pos-counters', icon: <Layers size={20} />, section: 'Admin', permission: 'settings' },
    { name: 'Billing & Plans', path: '/billing', icon: <Wallet size={20} />, section: 'Admin', permission: 'settings' },
    { name: 'Stock Transfer', path: '/stock-transfer', icon: <Truck size={20} />, section: 'Operations', permission: 'inventory' },
    { name: t('settings'), path: '/settings', icon: <Settings size={20} />, section: 'Admin', permission: 'settings' },
